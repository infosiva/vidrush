 ...
 */
const config = { aiSystemPrompt: 'You are a helpful AI assistant for ReplyDesk.' }
...
export async function aiChat(
  ...
  const system = systemPrompt ?? (config as { aiSystemPrompt?: string }).aiSystemPrompt ?? 'You are a helpful AI assistant.'
